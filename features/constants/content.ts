...
export const contentPhases: Content = {
  Robótica: {
    ...
    ["Fase 03"]:{
      ...
      ['Aula 09']: 'O estudante aprendeu sobre os tipos, uso e aplicações de polias. No decorrer da aula o estudante desenvolveu o projeto ponte elevadiça que utiliza de poliad parar subir e abaixar.',
      ['Aula 10']: 'O estudante aprendeu sobre o movimento circular, entendendo toas as suas particularidades bem como suas grandezas. No decorrer da aula o estudante produziu o projeto roda gigante que simula o movimento circular.',
