...
export const contentPhases: Content = {
  Robótica: {
    ["Fase 01"]:{
      ...
      ['Aula 09']: 'O estudante aprendeu sobre os diferentes tipos e uso de energias renováveis e não renováveis. No deccorer da aula o estudante desenvolveu e programou o projeto moinho de vento.',
    ...
    ["Fase 02"]:{
      ...
      ['Aula 02']: 'O estudante aprendeu sobre o conceito e uso da pneumática, ciência que estuda o uso do gás ou ar pressurizado.No deccorrer da aula o estudante criou o projeto empilhadeira que utiliza o ar comprimido de seringas para empilhar objetos.',
      ...
      ['Aula 05']: 'O estudante aprendeu sobre o conceito e aplicação do movimento retilíneo uniforme. No decorrer da aula o aluno produziu o projeto radar de velocidade, o qual emite um sinal vermelho e alarme para objetos acima da velocidade permitida.',
      ...
      ['Aula 10']: 'O estudante entendeu o conceito e aplicação das 3 leis de Newton (Lei da Inércia, Princípio Fundamental da Dinâmica e Lei da Ação e Reação). No decorrer da aula o estudante produziu o projeto de um robô que testa os princípios da ação e reação.',
    ...
    ["Fase 03"]:{
      ...
      ['Aula 04']: 'O estudante aprendeu sobre a força da gravidade, entendendo suas características como a força peso que atua sobre todo objeto. No decorrer da aula o estudante produziu uma balança  com indicadores para informar qual dos lados está mais pesado.',
    ...
    ["Fase 04"]:{
      ['Aula 01']: 'O estudante aprendeu sobre a automação de tarefas com robótica. No decorrer da aula o estudante criou o projeto braço robótico, capaz de realizar tarefas .',
      ...
      ['Aula 03']: 'O estudante aprendeu sobre os instrumentos musicais digitais, entendendo o funcionamento do teremim. No decorrer da aula o estudante produziu o instrumento musical digital teremim capaz de emitir som utilizando potenciômetro, speaker e sensores infravermlhos.',
      ['Aula 04']: 'O estudante aprendeu sobre automação residencial, criando no decorrer da aula uma casa automatizada que funciona através de sensores.',
      ...
      ['Aula 06']: 'O estudante aprendeu sobre as diferentes memórias (volátil e não volátil) e seus tipos (primária e secundária). No decorrer da aula o estudante desenvolveu um robô capaz de gravar comandos e depois executá-lo como programado.',
      ...
      ['Aula 09']: 'O estudante teve contato mais profundo com a programação, aprendendo o conceito de listas, threads e funções. No decorrer da aula o estudante criou um robô genius que funciona como um jogo com o propósito de memorização de cores e sons.',
      ...
      ['Aula 11']: 'O estudande aprendeu sobre o processo de envio de informações, entendeu também a importância e conceito de codificação. No decorrer da aula o estudante desenvolveu um telégrafo capaz de emitir mensagens em código morse.',
      ['Aula 12']: 'O estudante aprendeu sobre o uso de engrenagens em automóveis, entendo a funçao e conceito das marchas. No decorrer da aula o estudante desenvolveu um robô que por meio de botões e um potenciômetro simula o aumento da velocidade e necessidade de troca da marcha de um carro.',
    }
  }
} 